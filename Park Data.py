...
preferences = {}
#preferences['Exercise_Equipment'] = "Yes"
#preferences['Dog_Off_Leash_Area'] = "Yes"
#preferences['Toilets'] = "Yes"
...
while suburb != 'x':
    try:
        ...
        for row in results:
            ...
            print(row['ADDRESS'], "  Has toilets?", row['Toilets'], "  Rating:", row['Rating'], pref)
